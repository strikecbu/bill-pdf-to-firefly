...
CATEGORY_RULES = {
    ...
    "生活與起居": {
        "雜貨": ["全聯", "家樂福", "頂好", "美聯社", "7-11", "全家", "OK", "萊爾富", "統一超商"],
        "水電費": ["台電", "台灣自來水", "水費"],
        "日用生活品": ["宜家", "藥局", "光南", "蝦皮"],
        "電信帳單": ["中華電信", "遠傳", "台灣大"],
        "網路寬頻": ["中華電信HiNet", "凱擘"],
        "衣服": ["UNIQLO", "ZARA", "H&M", "GU"],
        "甜食/飲料": ["星巴克", "Starbucks", "路易莎", "LOUISA", "50嵐", "清心", "得正", "ＵＧＴＥＡ", "ｃｏｃｏ"],
        "食材": ["市場", "魚市"],
        "個人保養": ["屈臣氏", "Watsons", "康是美", "Cosmed"],
    },
    "娛樂與休閒": {
        "餐飲/外食": ["餐廳", "小吃", "麵", "飯", "鍋", "壽司", "麥當勞", "ＳＵＫＩＹＡ", "摩斯", "肯德基", "必勝客", "Pizza Hut", "三商巧福", "老先覺","１２ＭＩＮＩ"],
        "旅遊": ["飯店", "旅館", "民宿", "Booking", "Agoda"],
        "娛樂": ["電影", "KTV", "遊樂"],
        "訂閱服務": ["Netflix", "Spotify", "YouTube", "Disney", "Apple", "GITHUB"],
    },
    "其他": {
